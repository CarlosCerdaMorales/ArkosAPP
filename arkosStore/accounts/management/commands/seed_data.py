...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        IMAGES_SOURCE_DIR = os.path.join(settings.BASE_DIR, 'workers', 'fixtures', 'images')
        
        if not os.path.exists(IMAGES_SOURCE_DIR):
            self.stdout.write(self.style.WARNING(f'No existe la carpeta {IMAGES_SOURCE_DIR}'))
        ...
        workers_conf = [
            ...
            (
                "Yassine Bounou", 
                [TypeChoices.NUTRITIONAL_ADVICE, TypeChoices.EMOTIONAL_TECH, TypeChoices.OTHER], 
                "bono.jpg",
